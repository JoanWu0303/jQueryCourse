$(function () {
    ...
    $("#form").submit(function (event) {
        ...
        if (textarea.val().trim() == "") {
            ...
            // The default event now would be to submit the form. 
            //The browser will do this automatically when clicking a submit button.
            //We prevent this using preventDefault(). This way, the form will not be submitted.
