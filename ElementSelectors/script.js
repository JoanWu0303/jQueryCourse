...
$(function () {
  ...
  $("p").css("background-color", "rgba(180,100,30,0.8)");
  // $(".red-box").css("background-color", "rgba(180,100,30,0.8)");
  //$("#list").css("background-color", "rgba(180,100,30,0.8)");
  //$("input[type='email']").css("background-color", "rgba(180,100,30,0.8)");
  //$("input[type='text']").css("background-color", "rgba(180,100,30,0.8)");
  //$("p,h1,input").css("background-color", "rgba(180,100,30,0.8)");
  //$("p:last").css("background-color", "rgba(180,100,30,0.8)");
  //$("li:odd").css("background-color", "rgba(180,100,30,0.8)");
});
