$(function () {
  ...
  // To set the value of an attribute, you call the attr() function with two arguments:
  // First, the name of the attribute you want to change
  // Secondthe new value:
  link.attr("href", "http://petersommerhoff.com");

  // 2) Properties with prop()特性
